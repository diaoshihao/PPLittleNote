...
class UserInfo: NSObject, NSCoding {
    ...
    init(from: String, name: String, sex: String, age: String, birthday: String, idType: String, id: String, merriage: String, profession: String, income: String, insurence: String, mobilephone: String, telephone: String, address: String) {
        super.init()
...
class PersonModel: NSObject {
    ...
    func saveData(info: UserInfo) -> Bool {
        ...
        let index = infoExists(id: info.id)
        if index != -1 {
